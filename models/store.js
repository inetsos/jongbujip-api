...
var storeSchema = mongoose.Schema({
    ...
    storeName: {
        type: String,
        required: [true, '상호을 입력하세요.'],
        match: [/^.{2,40}$/,'2~40자 문자열입니다 .'],
        trim:true,
        unique:true
    },
    phone:{
...
// virtuals
storeSchema.virtual('confirmPassword')
    .get(function(){ return this._confirmPassword; })
    .set(function(value){ this._confirmPassword=value; });

storeSchema.virtual('originalPassword')
    .get(function(){ return this._originalPassword; })
    .set(function(value){ this._originalPassword=value; });

storeSchema.virtual('currentPassword')
    .get(function(){ return this._currentPassword; })
    .set(function(value){ this._currentPassword=value; });

storeSchema.virtual('newPassword')
...
// model & export
var Store = mongoose.model('user',storeSchema);
